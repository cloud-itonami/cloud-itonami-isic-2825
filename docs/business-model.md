# Business Model: Manufacture of machinery for food, beverage and tobacco processing
...
## Classification
- Repository: `cloud-itonami-isic-2825` ([github.com/cloud-itonami/cloud-itonami-isic-2825](https://github.com/cloud-itonami/cloud-itonami-isic-2825))
- ISIC Rev.5: `2825` — Manufacture of machinery for food, beverage and tobacco processing
- Domain: `:food-beverage-tobacco-machinery/manufacturing`
- Social impact: :worker-safety :mechanical-safety :food-contact-material-compliance
- Actor: `:food-beverage-tobacco-machinery-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :food-beverage-tobacco-machinery/manufacturing — who wants
...
One managed tenant (:food-beverage-tobacco-machinery/manufacturing):
...
- Do not bypass the `:food-beverage-tobacco-machinery-plant-operations-governor` for production decisions.
