# Operator Quickstart — Manufacture of machinery for food, beverage and tobacco processing

Shortest path from clone to a verified local dry-run for **ISIC 2825** (`cloud-itonami-isic-2825`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2825.git
cd cloud-itonami-isic-2825
```
...
- Blueprint governor key: `food-beverage-tobacco-machinery-plant-operations-governor`
- Likely source path: `foodmachmfg.governor.cljc`
