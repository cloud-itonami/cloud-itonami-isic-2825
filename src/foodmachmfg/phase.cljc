(ns foodmachmfg.phase
  "Phase 0->3 staged rollout for the food, beverage and tobacco
  processing-machinery (industrial mixers, filling machines, packaging
  machines, bottling lines and tobacco processing machines)
  ...
  `foodmachmfg.governor`'s `equipment-actuate-blocked-violations`
...
(defn verdict->disposition
  "Map a Food, Beverage and Tobacco Machinery Plant Operations Governor
